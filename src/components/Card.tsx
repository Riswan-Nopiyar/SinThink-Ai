...
interface CardProps {
  ...
  categories: string[];
  description: string;
  link: string; // Route internal atau URL eksternal
  Icon: IconType;
}

const Card: React.FC<CardProps> = ({ title, categories, description, link, Icon }) => {
  return (
    <div className="relative flex flex-col rounded-xl bg-white dark:bg-slate-800 bg-clip-border text-gray-700 shadow-md dark:border dark:border-gray-700 h-full">
      {/* Icon Section */}
      ...
      <div className="p-6 flex-grow">
        <h5 className="mb-2 dark:text-white block text-xl font-semibold leading-snug">
          {title}
        </h5>
